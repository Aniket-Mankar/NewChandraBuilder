...
class BuilderInsidePage extends Component {
  state = {
    quentity: '',
    metalColor: '',
    metalKarat: '',
...
getMetalColorValueLarge =  event => {
  ...
  makeCallForFont = async () => {
    ...
    this.setState({ errorMessages: {}, isUpdated: false, isFinalized: true, });
...
//const urlNwew = `https://chandrajewellery.api.ls2.kenmarkserver.com/costing?quantity=${make}&metalColor=${metalColor}&metalKarat=${metalKarat}&DiamondQuality=${DiamondQuality}&fontStyle=${fontStyle}&letterHeight=${letterHeight}&customName=${customName}`;
    try {
      ...
      if (findData && findData.paths) {
        this.setState({
          ...
          chainImages: findData.chainImages,
  ...
  makeImagesContainer = () => {
    const { path, chainImages} = this.state;
    
    const validPaths = [
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/A/A YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/A/A YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/A/A WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/A/A WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/A/A PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/A/A PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/L/L PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/L/L PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/L/L YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/L/L YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.30 INCH) DONE/L/L WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-COLLEGE FONT(0.35 INCH) DONE/L/L WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/L/L PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/L/L PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/L/L YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/L/L YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/L/L WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/L/L WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/A/A PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/A/A PG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/A/A YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/A/A YG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.30 INCH) DONE/A/A WG.png",
      "https://chandrajewellery.api.ls2.kenmarkserver.com/JMT-SOURCE SANS PRO FONT(0.35 INCH) DONE/A/A WG.png"
    ];
  
    const currentPath = path[path.length - 1];
    const condition = validPaths.includes(currentPath);
  ...
  const activeCondition = condition3.includes(activePath)
    ...
    if (!path || path.length === 0) {
      return (
        <div className="option-container">
          <img
            src="https://therunawaycrew.com/wp-content/uploads/2024/07/Group-491.png"
            alt="option"
    ...
    return (
      <div>
      <div className="img-chain-container">
        <img
          src={chainImages[0]}
          alt="left"
          className={activeCondition ? "left-img-a" : "left-img"}
        />
        <ul type="none" className="list-of-img">
          {path.map((each, index) => (
            <img key={index} src={each} alt={each} className={`${letterHeight === "Medium" ? "finel-img" : "finel-img-large"}`}/>
          ))}
        </ul>
        <img
          src={chainImages[1]} 
          alt="left"
          className={condition ? "right-img-a" : "right-img" }
        />
      </div>
          ...
          <Popup isOpen={this.state.isPopupOpen} onClose={this.closePopup} />
              ...
              <div className="input-container">
                ...
                <div className='color-button-container'>
                  ...
                  <img src="https://therunawaycrew.com/wp-content/uploads/2024/09/Clip-path-group.png" alt="color" value="Platinum" />
                  </button>
                </div>
              </div>
              <div className="input-container">
...
export default BuilderInsidePage
